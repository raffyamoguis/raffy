                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="card-box text-center p-5 border shadow">
                                <img src={anisocial} alt='Ongoing Projects' />
                                <h3>Weeb Hub</h3>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card-box text-center p-5 border shadow">
                                <img src={bikeshop} width='66' height='66' alt='Ongoing Projects' />
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card-box text-center p-5 border shadow">
                                <img src={youtubed} width='66' height='66' alt='Ongoing Projects' />
